...
ENV SERVER_NAME="SoulmaskServerByMe" \
    ...
    PUID=2198 \
    PGID=2198 \
    GAMEBASECONFIGDIR="/config/gamefiles/soulmask/Saved/Config" \
    GAMECONFIGDIR="/config/gamefiles/soulmask/Saved/Config/LinuxServer" \
    GAMESAVESDIR="/config/gamefiles/soulmask/Saved/SaveGames" \
    BACKUP=900 \
    SAVING=600 \
    SKIPUPDATE="false" \
    GAME_MODE="pve" \
